<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:64:"F:\website\WWW\website\public/../app/admin\view\index\index.html";i:1523512650;s:54:"F:\website\WWW\website\app\admin\view\public\base.html";i:1523516908;s:56:"F:\website\WWW\website\app\admin\view\public\header.html";i:1523512866;s:54:"F:\website\WWW\website\app\admin\view\public\left.html";i:1523523960;s:56:"F:\website\WWW\website\app\admin\view\public\footer.html";i:1523522848;}*/ ?>
<!DOCTYPE html>
        ...
        <ul class="nav" id="main-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo url('Banner/index'); ?>"><i class="glyphicon glyphicon-list"></i>广告列表</a>
                    </li>
                    <li>
                        <a href="<?php echo url('Banner/create'); ?>"><i class="glyphicon glyphicon-plus-sign"></i>添加广告</a>
                    </li>
            ...
            <li>
                <a href="#"><i class="glyphicon glyphicon-comment"></i>语录管理 <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo url('Book/index'); ?>"><i class="glyphicon glyphicon-list"></i>语录列表</a>
                    </li>
                    <li>
                        <a href="<?php echo url('Book/create'); ?>"><i class="glyphicon glyphicon-plus-sign "></i>添加语录</a>
                    </li>

                </ul>
            </li>
            <li>
                <a href="#"><i class="glyphicon glyphicon-globe"></i>友情连接 <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo url('Book/index'); ?>"><i class="glyphicon glyphicon-list"></i>友情连接列表</a>
                    </li>
                    <li>
                        <a href="<?php echo url('Book/create'); ?>"><i class="glyphicon glyphicon-plus-sign "></i>添加友情连接</a>
                    </li>

                </ul>
            </li>
            <li>
                <a href="#"><i class="glyphicon glyphicon-cog"></i>系统管理 <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="<?php echo url('Page/index'); ?>"><i class="glyphicon glyphicon-pushpin"></i>关于我们</a>
                    </li>
...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">中金管理系统后台</h1>
                <h1 class="page-subhead-line"><a href="<?php echo url('Index/index'); ?>" style="text-decoration: none;">首页</a> </h1>
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="user-img pull-right">
                                            <img src="/static/admin/assets/img/user.gif" alt="" class="img-u image-responsive" />
                                        </div>
                                ...
                                <div class="item">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <h4><i class="fa fa-quote-left"></i>Lorem ipsum dolor sit amet, consectetur adipiscing Lorem ipsum dolor sit amet, consectetur adipiscing elit onec molestie non sem vel condimentum. <i class="fa fa-quote-right"></i></h4>
                                        <div class="user-img pull-right">
                                            <img src="/static/admin/assets/img/user.png" alt="" class="img-u image-responsive" />
                                        </div>
                                        <h5 class="pull-right"><strong class="c-black">Lorem Dolor</strong></h5>
                                    </div>
                    ...
                    <div id="carousel-example" class="carousel slide" data-ride="carousel" style="border: 5px solid #000;">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                ...
                                <img src="/static/admin/assets/img/slideshow/1.jpg" alt="" />

                            </div>
                            <div class="item">
                                <img src="/static/admin/assets/img/slideshow/2.jpg" alt="" />

                            </div>
                            <div class="item">
                                <img src="/static/admin/assets/img/slideshow/3.jpg" alt="" />
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object img-circle img-comments" src="/static/admin/assets/img/user.png" />
                                        </a>
                                        <div class="media-body">
                                            ...
                                            <div class="media">
                                                <a class="pull-left" href="#">
                                                    <img class="media-object img-circle img-comments" src="/static/admin/assets/img/user.gif" />
                                                </a>
                                                <div class="media-body">
    ...
    <div id="footer-sec">
    &copy; 2018<a href="" target="_blank" title="中金在线">中金在线</a> - Collect from <a href="" title="中金在线" target="_blank">中金在线</a>
</div>
